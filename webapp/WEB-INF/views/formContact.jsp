...
<html lang="en">
   ...
   <body>
      ...
      <div class="container theme-showcase" role="main">
         ...
         <form:form class="form-horizontal" method="post" action="${ urlRoot }contact" modelAttribute="contact">
            <div class="form-group">
               <label for="name" class="col-sm-2 control-label">Nombre</label>
               <div class="col-sm-10">
                  <form:input type="text" class="form-control" id="name" path="name" placeholder="Nombre" required="required"/>
               </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               <label for="genre" class="col-sm-2 control-label">Géneros Favoritos</label>
               <div class="col-sm-10">
                  <form:select id="genre" path="genre" multiple="multiple" class="form-control"
							items="${ genres }" />
               </div>
            </div>
            ...
            <div class="form-group">
               <label class="col-sm-2 control-label" for="coments">Comentarios:</label>
               <div class="col-sm-10">
                  <form:textarea class="form-control" path="coments" id="coments" rows="5"></form:textarea>
               </div>
            </div>
