...
<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container">
		...
		<sec:authorize access="hasAnyAuthority('EDITOR')">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a href="${ urlRoot }movies/indexPaginate?page=0">Películas</a></li>
					<li><a href="${ urlRoot }schedules/indexPaginate?page=0">Horarios</a></li>
					<li><a href="${ urlRoot }news/indexPaginate?page=0">Noticias</a></li>					
