        ...
        <div class="row">
			...
			<c:forEach items="${ movies }" var="movie">
	          <div class="col-xs-12 col-sm-6 col-md-3">
	            <img class="img-rounded" src="${urlPublic }/images/${ movie.image }" alt="Generic placeholder image" width="150" height="200">
	            <h4>${ movie.title}</h4>
	            <h4>
	              <span class="label label-default">${ movie.rating }</span>
	            ...
	            <p><a class="btn btn-sm btn-primary" href="detail?idMovie=${ movie.id }&date=${ searchDate }" role="button">Consulta Horarios &raquo;</a></p>
	          </div>
			</c:forEach>          
